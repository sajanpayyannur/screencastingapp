...
class Admin::PagesControllerTest < ActionController::TestCase
  setup do
    ...
    @admin_page = FactoryGirl.create(:page)
  end
  ...
  test "should create admin_page" do
    assert_difference('Admin::Page.count') do
      post :create, admin_page: { publish: @admin_page.publish, text: @admin_page.text, title: @admin_page.title }
    end
  ...
  test "should update admin_page" do
    put :update, id: @admin_page, admin_page: { publish: @admin_page.publish, text: @admin_page.text, title: @admin_page.title }
    assert_redirected_to admin_page_path(assigns(:admin_page))
  end
